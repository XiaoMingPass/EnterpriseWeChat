...
public class WxServiceClientTest {
    ...
    public void init() throws Exception {
        ...
        personService = (IPersonService) ac.getBean("ehrPersonService");
    ...
    public void testGetUsersFile() {
        try {
            ...
            if (!wxServiceClient.verifyTokenValid(tokenTime, access_token)) {
                wxServiceClient.getToken();
            }
            //拉取正式环境人员数据,department_id=1,表示从最顶层获取数据
            List<UserlistBean> wxUserList = wxServiceClient.getUserDetails(access_token, 1);
            //获取ehr第一页人员信息数据
