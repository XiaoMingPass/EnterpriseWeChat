...
public class ToCSVUtils {
    ...
    public static File createCSVFile(List<Map<String, String>> exportData, LinkedHashMap map, String outPutPath, String fileName) {
        File csvFile = null;
        ...
        try {
            ...
            // UTF-8使正确读取分隔符",",如果中文乱码修改为GBK编码格式
            ...
            for (Iterator iterator = exportData.iterator(); iterator.hasNext(); ) {
                ...
                for (Iterator propertyIterator = map.entrySet().iterator(); propertyIterator.hasNext(); ) {
                    java.util.Map.Entry propertyEntry = (java.util.Map.Entry) propertyIterator.next();
                    String line = BeanUtils.getProperty(row, (String) propertyEntry.getKey());
                    if(null != line){
...
//
//        String path = "D:/Out/";
//        String fileName = "WxTest";
//        File file = ToCSVUtils.createCSVFile(exportData, map, path, fileName);
